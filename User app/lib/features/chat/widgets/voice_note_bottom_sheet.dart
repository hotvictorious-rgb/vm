          ...
          children: [
            ...
            if (!_hasRecorded) ...[
              Text(
                ...
                style: textMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: _isRecording ? Colors.red : null),
              ),
              ...
              Row(
                ...
                children: [
                  TextButton.icon(
                    ...
                    label: Text(getTranslated('delete', context) ?? 'Delete', style: textRegular.copyWith(color: Theme.of(context).colorScheme.error)),
                  ),
                  ElevatedButton.icon(
                    onPressed: _sendVoiceNote,
                    style: ElevatedButton.styleFrom(backgroundColor: Theme.of(context).primaryColor),
                    icon: const Icon(Icons.send, color: Colors.white),
                    label: Text(getTranslated('send', context) ?? 'Send', style: textMedium.copyWith(color: Colors.white)),
                  )
                ],
              )
            ],
